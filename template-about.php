<?php
/**
 * Template Name: Faraa Tourism — About
    ...
    <div class="laxora-container laxora-about-grid__inner">
        <div class="laxora-about-grid__left">
            ...
            <p class="laxora-about-grid__body">
                <?php esc_html_e( 'At Faraa Tourism, we specialise in delivering a professional chauffeur service with a focus on luxury, safety, and unmatched customer satisfaction. Our dedicated team and diverse fleet are at the heart of what makes each journey smooth, stylish, and memorable.', 'laxora' ); ?>
            </p>
        ...
        <div class="laxora-about-grid__right">
            <p class="laxora-lead">
                <?php esc_html_e( 'At Faraa Tourism, we are passionate about delivering unforgettable journeys. As a leading name in professional chauffeur services and luxury car rentals, we specialise in providing top-tier vehicles and tailored travel experiences across more than 20 cities worldwide.', 'laxora' ); ?>
            </p>
            <div class="laxora-about-grid__image">
                <img src="<?php echo esc_url( LAXORA_URI . '/assets/images/services/luxury-chauffeur.jpg' ); ?>" alt="<?php esc_attr_e( 'Faraa Tourism luxury sedan', 'laxora' ); ?>" loading="lazy">
            </div>
        </div>
    </div>
</section>
...
<section class="laxora-about-band">
    <div class="laxora-container">
        ...
        <div class="laxora-band-head">
            ...
            <p class="laxora-lead">
                <?php esc_html_e( 'At Faraa Tourism, we take pride in delivering exceptional service with a focus on luxury, safety, and reliability. Experience the difference \u2014 book your ride today.', 'laxora' ); ?>
            </p>
        </div>
