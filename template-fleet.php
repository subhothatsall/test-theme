<?php
/**
 * Template Name: Faraa Tourism — Fleet
...
<section class="laxora-premium-banner" style="background-image: linear-gradient(rgba(255, 255, 255, 0.85), rgba(255, 255, 255, 0.85)), url('<?php echo esc_url( LAXORA_URI . '/assets/images/fleet-page/premium-cta.jpg' ); ?>');">
    <div class="laxora-container laxora-premium-banner__inner">
        ...
        <p class="laxora-lead">
            <?php esc_html_e( 'Available 24/7, our Faraa Tourism chauffeur-driven cars feature comfort, top-tier performance, and elegance. All vehicles include premium interiors, polished exteriors, and the highest standard of service.', 'laxora' ); ?>
        </p>
    ...
    <div class="laxora-container">
        ...
        $testimonials = array(
            array(
                ...
                'date'     => '2 weeks ago',
                'rating'   => 5,
                'text'     => __( 'Top quality and on-time chauffeur every single ride. The cars are immaculate, the drivers polite, and the booking process is seamless. Faraa Tourism has become our go-to for all executive travel.', 'laxora' ),
            ),
            array(
                'platform' => 'Trustpilot',
                'badge'    => 'T',
                ...
                'date'     => '1 month ago',
                'rating'   => 5,
                'text'     => __( 'Very luxurious cars, very experienced chauffeurs. Booked Faraa Tourism for our wedding party and they exceeded every expectation. Will recommend to family and friends.', 'laxora' ),
            ),
            array(
                'platform' => 'Google',
                'badge'    => 'G',
                ...
                'date'     => '3 weeks ago',
                'rating'   => 5,
                'text'     => __( 'I have been using Faraa Tourism for over a year now for my client meetings. Reliable, discreet, and the quality of vehicles is consistently top-tier. Strongly recommended.', 'laxora' ),
            ),
            array(
                'platform' => 'Google',
                'badge'    => 'G',
