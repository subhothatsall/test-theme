<?php
/**
 * Template Name: Faraa Tourism — Services
    ...
    <div class="laxora-container laxora-about-grid__inner">
        <div class="laxora-about-grid__left">
            ...
            <p class="laxora-about-grid__body">
                <?php esc_html_e( 'From single airport transfers to multi-city corporate roadshows and once-in-a-lifetime celebrations, Faraa Tourism orchestrates every detail end-to-end. Quiet precision, deep discretion, and an uncompromised standard of luxury — across every service we offer.', 'laxora' ); ?>
            </p>
        ...
        <div class="laxora-about-grid__right">
            ...
            <div class="laxora-about-grid__image">
                <img src="<?php echo esc_url( LAXORA_URI . '/assets/images/fleet-page/sedan-service.jpg' ); ?>" alt="<?php esc_attr_e( 'Faraa Tourism chauffeur service', 'laxora' ); ?>" loading="lazy">
            </div>
        </div>
    </div>
</section>
...
<section class="laxora-about-band">
    <div class="laxora-container">
        ...
        <div class="laxora-band-head">
            ...
            <p class="laxora-lead">
                <?php esc_html_e( 'Every Faraa Tourism service is built around four non-negotiables: response speed, fleet variety, around-the-clock availability, and absolute discretion. These are the metrics we are judged by — and the ones we never compromise on.', 'laxora' ); ?>
            </p>
        </div>
