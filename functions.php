...
function laxora_add_page_templates( $templates ) {
    $templates['template-fullwidth.php'] = __( 'Faraa Tourism — Full Width Canvas', 'laxora' );
    $templates['template-about.php']     = __( 'Faraa Tourism — About', 'laxora' );
    $templates['template-services.php']  = __( 'Faraa Tourism — Services', 'laxora' );
    $templates['template-service-airport.php']  = __( 'Faraa Tourism — Airport Transfers', 'laxora' );
    $templates['template-service-business.php'] = __( 'Faraa Tourism — Business Meetings', 'laxora' );
    $templates['template-service-wedding.php']  = __( 'Faraa Tourism — Wedding Transfers', 'laxora' );
    $templates['template-fleet.php']     = __( 'Faraa Tourism — Fleet', 'laxora' );
    $templates['template-contact.php']   = __( 'Faraa Tourism — Contact', 'laxora' );
    return $templates;
}
...
function laxora_customize_register( $wp_customize ) {
    $wp_customize->add_section( 'laxora_brand', array(
        'title'    => __( 'Faraa Tourism — Brand & Contact', 'laxora' ),
        'priority' => 30,
    ) );
    ...
    $wp_customize->add_setting( 'laxora_email', array( 'default' => 'Faraaelitetoursandtravel@gmail.com', 'sanitize_callback' => 'sanitize_email' ) );
