<?php
/**
 * Home hero section — Full-bleed cover image background.
 *
 * @package Laxora
 */

$hero_image = LAXORA_URI . '/assets/images/hero-bright.png';
?>
<section id="hero" class="laxora-hero">
    <div class="laxora-hero__bg" aria-hidden="true">
        <img src="<?php echo esc_url( $hero_image ); ?>" alt="<?php esc_attr_e( 'Faraa Tourism Premium Fleet', 'laxora' ); ?>">
    ...
    <div class="laxora-container laxora-hero__inner">
        ...
        <p class="laxora-hero__lead">
            <?php esc_html_e( 'Faraa Tourism delivers a discreet, world-class chauffeur experience for executives, dignitaries, and private clientele across the world’s most demanding cities.', 'laxora' ); ?>
        </p>
