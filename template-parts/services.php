...
<section id="services" class="laxora-services">
    <div class="laxora-container laxora-services__grid">
        <div class="laxora-services__intro">
            ...
            <p class="laxora-lead"><?php esc_html_e( 'From international arrivals to multi-day corporate engagements, every Faraa Tourism journey is choreographed end to end.', 'laxora' ); ?></p>

            <div class="laxora-services__image">
                <img src="<?php echo esc_url( LAXORA_URI . '/assets/images/interior.jpg' ); ?>" alt="<?php esc_attr_e( 'Faraa Tourism chauffeur interior', 'laxora' ); ?>" loading="lazy">
