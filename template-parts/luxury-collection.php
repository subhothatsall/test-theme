...
<section id="fleet" class="laxora-fleet">
    ...
    <div class="laxora-container">
        <div class="laxora-fleet__header">
            <span class="laxora-pill-eyebrow"><?php esc_html_e( 'The Faraa Tourism Fleet', 'laxora' ); ?></span>
            <h2 class="laxora-h2">
                <span><?php esc_html_e( 'Check our', 'laxora' ); ?></span>
                <span class="laxora-gradient-text"><?php esc_html_e( 'Luxury Collection', 'laxora' ); ?></span>
            </h2>
            <p class="laxora-lead">
                <?php esc_html_e( 'Faraa Tourism curates a premier portfolio of executive vehicles — from chauffeur-driven sedans and ultra-luxury SUVs to MPVs and coaches — delivering an uncompromised standard of comfort, privacy, and punctuality across every journey.', 'laxora' ); ?>
            </p>
        </div>
        ...
        <div class="laxora-fleet__grid" data-laxora-grid>
            <?php foreach ( $fleet as $v ) :
                $whatsapp_msg = sprintf( /* translators: %s: vehicle name */ __( 'Hello Faraa Tourism, I’d like to inquire about the %s.', 'laxora' ), $v['name'] );
            ?>
