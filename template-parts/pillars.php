        ...
        <div class="laxora-pillars__head">
            <div class="laxora-pillars__intro">
                <div class="laxora-eyebrow-row laxora-eyebrow-row--left">
                    ...
                    <span class="laxora-eyebrow"><?php esc_html_e( 'The Faraa Tourism Standard', 'laxora' ); ?></span>
                </div>
            ...
            <div class="laxora-pillars__image">
                <img src="<?php echo esc_url( LAXORA_URI . '/assets/images/hero.jpg' ); ?>" alt="<?php esc_attr_e( 'Faraa Tourism chauffeur at night', 'laxora' ); ?>" loading="lazy">
