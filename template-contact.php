<?php
/**
 * Template Name: Faraa Tourism — Contact
...
get_template_part( 'template-parts/page-banner', null, array(
    ...
    'subtitle' => __( 'Reach out for a bespoke proposal, fleet availability, or to engage Faraa Tourism for an ongoing executive programme.', 'laxora' ),
...
$email    = get_theme_mod( 'laxora_email', 'Faraaelitetoursandtravel@gmail.com' );
...
<section class="laxora-contact-tiles">
    <div class="laxora-container laxora-contact-tiles__grid">
        <a href="<?php echo esc_url( laxora_whatsapp_link( __( 'Hello Faraa Tourism, I would like a quotation.', 'laxora' ) ) ); ?>" target="_blank" rel="noopener" class="laxora-contact-tile" style="--c:#14B8A6;">
    ...
    <div class="laxora-container laxora-inquiry__grid">
        ...
        <div class="laxora-inquiry__form">
            ...
            if ( ! empty( $shortcode ) ) {
                ...
                echo '<p class="laxora-lead">' . esc_html__( 'Configure the inquiry shortcode in Appearance → Customize → Faraa Tourism — Brand & Contact.', 'laxora' ) . '</p>';
            }
            ?>
        </div>
    </div>
